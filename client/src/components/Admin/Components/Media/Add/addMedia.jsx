...
import { addMedia } from '../../../../../redux/Reducer/NewsMedia';
  ...
  const handleSave = async () => {
    ...
    if (Object.keys(formErrors).length === 0) {
      try {
        ...
        const filePath = await uploadFileWithUniqueName(imageFile, 'CGS', 'public/media');
        ...
        await dispatch(addMedia(updatedForm));
