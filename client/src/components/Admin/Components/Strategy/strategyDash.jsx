...
import { deleteStrategy, fetchStrategy, updateStrategy } from '../../../../redux/Reducer/NewsStrategy';
...
export default function StrategyDash() {
  ...
  const handleSave = () => {
    dispatch(updateStrategy(editFormData));
    setEditMode(null);
  };
  ...
  const filteredStrategyData = strategy.filter((item) =>
